...
import { Actions, Scene, Router, Switch, ActionConst } from 'react-native-router-flux'
  ...
  <Scene
    ...
    component={connect(
      state => ({
        ...
        isUserProfileComplete: state.auth.isUserProfileComplete,
      }),
    )(Switch)}
  ...
  >
    ...
    >
      <Scene
        ...
        direction="vertical" type={ActionConst.RESET} initial={true}
      />
      <Scene
        key="RegisterEmail" component={RegisterEmail} title="Register" hideNavBar={false}
        navBar={BetBashNavbar} direction="vertical"
        onRight={() => Actions.LoginEmail()} rightTitle="Login"
        backTitle="Back"
      />
      <Scene
        key="LoginEmail" component={LoginEmail} title="Login" hideNavBar={false}
        navBar={BetBashNavbar}
        backTitle="Register"
      />
    </Scene>

    <Scene
      key="CompleteProfile" component={CompleteProfile} title="Hi! What's your name?"
      hideNavBar={false}
      navBar={BetBashNavbar} direction="horizontal"
    />
    ...
    >
      <Scene
        key="BetBashMain" default="Home" hideNavBar={true}
        tabs={true} tabBarStyle={tabbarStyle}
      >
        <Scene
          key="Home" component={Home} title="Home" hideNavBar={true}
          icon={BetBashTabIcon} initial={true}
        />
        <Scene
          key="Games" component={Games} title="Games" hideNavBar={true}
          icon={BetBashTabIcon}
        />
        <Scene
          key="Profile" component={Profile} title="Profile" hideNavBar={true}
          icon={BetBashTabIcon}
        />
      </Scene>
      <Scene
        key="CreateGame" component={CreateGame} title="Start a new game!" hideNavBar={ false }
        navBar={BetBashNavbar} direction="vertical"
      />
    </Scene>
